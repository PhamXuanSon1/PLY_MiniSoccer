...
if ( TRACE ) { TRACE( "SoundData#init", this ); }
    ...
    /*SpriteSizeAdapter start.*/
    Bridge.define("SpriteSizeAdapter", {
        inherits: [UnityEngine.MonoBehaviour],
        statics: {
            methods: {
                /*SpriteSizeAdapter.SetSpriteRendererSize:static start.*/
                SetSpriteRendererSize: function (sr, sprite, targetSize, mode) {
if ( TRACE ) { TRACE( "SpriteSizeAdapter#SetSpriteRendererSize", this ); }
                    ...
                    sr.sprite = sprite;
                    if (sprite == null || targetSize.x <= 0.0 || targetSize.y <= 0.0) {
                        return;
                    }
                    var size = UnityEngine.Vector2.FromVector3(sprite.bounds.halfExtents.$clone().scale( 2 ).$clone());
                    if (!(size.x <= 0.0) && !(size.y <= 0.0)) {
                        var scaleX = targetSize.x / size.x;
                        var scaleY = targetSize.y / size.y;
                        var num;
                        switch (mode) {
                            default: 
                                num = scaleX;
                                break;
                            case SpriteSizeAdapter.FitMode.Envelope: 
                                num = UnityEngine.Mathf.Max(scaleX, scaleY);
                                break;
                            case SpriteSizeAdapter.FitMode.FitInside: 
                                num = UnityEngine.Mathf.Min(scaleX, scaleY);
                                break;
                        }
                        var chosenScale = num;
                        if (mode === SpriteSizeAdapter.FitMode.ExactStretch) {
                            sr.transform.localScale = new pc.Vec3( scaleX, scaleY, 1.0 );
                        } else {
                            sr.transform.localScale = new pc.Vec3( chosenScale, chosenScale, 1.0 );
                        }
                    }
                },
                /*SpriteSizeAdapter.SetSpriteRendererSize:static end.*/
        ...
        ctors: {
            init: function () {
if ( TRACE ) { TRACE( "SpriteSizeAdapter#init", this ); }

                this.targetSize = new UnityEngine.Vector2();
                this.gizmoColor = new UnityEngine.Color();
                this.targetSize = new pc.Vec2( 2.0, 2.0 );
                this.fitMode = SpriteSizeAdapter.FitMode.FitInside;
                this.autoFitOnStart = true;
                this.showGizmos = true;
                this.gizmoColor = new pc.Color( 0.0, 1.0, 0.4, 0.6 );
            }
        },
        methods: {
            /*SpriteSizeAdapter.Awake start.*/
            Awake: function () {
if ( TRACE ) { TRACE( "SpriteSizeAdapter#Awake", this ); }

                this.CacheComponents();
            },
            /*SpriteSizeAdapter.Awake end.*/

            /*SpriteSizeAdapter.Start start.*/
            Start: function () {
if ( TRACE ) { TRACE( "SpriteSizeAdapter#Start", this ); }

                if (this.autoFitOnStart) {
                    this.ApplyFit();
                }
            },
            /*SpriteSizeAdapter.Start end.*/

            /*SpriteSizeAdapter.CacheComponents start.*/
            CacheComponents: function () {
if ( TRACE ) { TRACE( "SpriteSizeAdapter#CacheComponents", this ); }

                if (UnityEngine.Component.op_Equality(this._spriteRenderer, null)) {
                    this._spriteRenderer = this.GetComponent(UnityEngine.SpriteRenderer);
                }
                if (UnityEngine.MonoBehaviour.op_Equality(this._uiImage, null)) {
                    this._uiImage = this.GetComponent(UnityEngine.UI.Image);
                }
            ...
            /*SpriteSizeAdapter.CacheComponents end.*/

            /*SpriteSizeAdapter.SetSprite start.*/
            SetSprite: function (newSprite) {
if ( TRACE ) { TRACE( "SpriteSizeAdapter#SetSprite", this ); }

                this.CacheComponents();
                if (UnityEngine.Component.op_Inequality(this._spriteRenderer, null)) {
                    this._spriteRenderer.sprite = newSprite;
                } else if (UnityEngine.MonoBehaviour.op_Inequality(this._uiImage, null)) {
                    this._uiImage.sprite = newSprite;
                }
                this.ApplyFit();
            },
            /*SpriteSizeAdapter.SetSprite end.*/

            /*SpriteSizeAdapter.ApplyFit start.*/
            ApplyFit: function () {
if ( TRACE ) { TRACE( "SpriteSizeAdapter#ApplyFit", this ); }

                this.CacheComponents();
                if (UnityEngine.Component.op_Inequality(this._spriteRenderer, null)) {
                    this.FitSpriteRenderer();
                } else if (UnityEngine.MonoBehaviour.op_Inequality(this._uiImage, null)) {
                    this.FitUIImage();
                }
            },
            /*SpriteSizeAdapter.ApplyFit end.*/

            /*SpriteSizeAdapter.FitSpriteRenderer start.*/
            FitSpriteRenderer: function () {
if ( TRACE ) { TRACE( "SpriteSizeAdapter#FitSpriteRenderer", this ); }

                if (UnityEngine.Component.op_Equality(this._spriteRenderer, null) || this._spriteRenderer.sprite == null || this.targetSize.x <= 0.0 || this.targetSize.y <= 0.0) {
                    return;
                }
                var spriteOriginalSize = UnityEngine.Vector2.FromVector3(this._spriteRenderer.sprite.bounds.halfExtents.$clone().scale( 2 ).$clone());
                if (!(spriteOriginalSize.x <= 0.0) && !(spriteOriginalSize.y <= 0.0)) {
                    var scaleX = this.targetSize.x / spriteOriginalSize.x;
                    var scaleY = this.targetSize.y / spriteOriginalSize.y;
                    switch (this.fitMode) {
                        case SpriteSizeAdapter.FitMode.FitInside: 
                            {
                                var minScale = UnityEngine.Mathf.Min(scaleX, scaleY);
                                this.transform.localScale = new pc.Vec3( minScale, minScale, 1.0 );
                                break;
                            }
                        case SpriteSizeAdapter.FitMode.Envelope: 
                            {
                                var maxScale = UnityEngine.Mathf.Max(scaleX, scaleY);
                                this.transform.localScale = new pc.Vec3( maxScale, maxScale, 1.0 );
                                break;
                            }
                        case SpriteSizeAdapter.FitMode.ExactStretch: 
                            this.transform.localScale = new pc.Vec3( scaleX, scaleY, 1.0 );
                            break;
                    }
                }
            },
            /*SpriteSizeAdapter.FitSpriteRenderer end.*/

            /*SpriteSizeAdapter.FitUIImage start.*/
            FitUIImage: function () {
if ( TRACE ) { TRACE( "SpriteSizeAdapter#FitUIImage", this ); }

                if (UnityEngine.MonoBehaviour.op_Equality(this._uiImage, null) || this._uiImage.sprite == null || UnityEngine.Component.op_Equality(this._rectTransform, null) || this.targetSize.x <= 0.0 || this.targetSize.y <= 0.0) {
                    return;
                }
                var spriteRect = this._uiImage.sprite.rect.$clone();
                if (spriteRect.width <= 0.0 || spriteRect.height <= 0.0) {
                    return;
                }
                var aspect = spriteRect.width / spriteRect.height;
                var targetAspect = this.targetSize.x / this.targetSize.y;
                switch (this.fitMode) {
                    case SpriteSizeAdapter.FitMode.FitInside: 
                        if (aspect > targetAspect) {
                            this._rectTransform.sizeDelta = new pc.Vec2( this.targetSize.x, this.targetSize.x / aspect );
                        } else {
                            this._rectTransform.sizeDelta = new pc.Vec2( this.targetSize.y * aspect, this.targetSize.y );
                        }
                        break;
                    case SpriteSizeAdapter.FitMode.Envelope: 
                        if (aspect > targetAspect) {
                        ...
                        break;
                    case SpriteSizeAdapter.FitMode.ExactStretch: 
                        this._rectTransform.sizeDelta = this.targetSize.$clone();
                        break;
                }
            },
            /*SpriteSizeAdapter.FitUIImage end.*/

            /*SpriteSizeAdapter.OnDrawGizmosSelected start.*/
            OnDrawGizmosSelected: function () {
if ( TRACE ) { TRACE( "SpriteSizeAdapter#OnDrawGizmosSelected", this ); }

                if (this.showGizmos && !(this.targetSize.x <= 0.0) && !(this.targetSize.y <= 0.0)) {
                    pc.generateStubProxy( 'UnityEngine.Gizmos', true ).color = this.gizmoColor.$clone();
                    if (UnityEngine.Component.op_Inequality(this.GetComponent(UnityEngine.SpriteRenderer), null)) {
                        var center = this.transform.position.$clone();
                        var size = new pc.Vec3( this.targetSize.x, this.targetSize.y, 0.05 );
                        pc.stubProxy.reportMethod( 'UnityEngine.Gizmos.DrawWireCube', null );
                    }
                }
            },
            /*SpriteSizeAdapter.OnDrawGizmosSelected end.*/


        }
    });
    /*SpriteSizeAdapter end.*/

    /*SpriteSizeAdapter+FitMode start.*/
    Bridge.define("SpriteSizeAdapter.FitMode", {
        $kind: 1006,
        statics: {
            fields: {
                FitInside: 0,
...
if ( TRACE ) { TRACE( "Ply_SoundManager#Mute", this ); }
    ...
    var $m = Bridge.setMetadata,
        $n = ["System","UnityEngine","System.Collections.Generic","TMPro","System.Collections","DG.Tweening","UnityEngine.UI","UnityEngine.Audio","DG.Tweening.Core","DG.Tweening.Plugins.Core.PathCore","System.Globalization","DG.Tweening.Plugins.Options"];
    ...
    /*SpriteSizeAdapter start.*/
    $m("SpriteSizeAdapter", function () { return {"nested":[SpriteSizeAdapter.FitMode],"att":1048577,"a":2,"at":[new UnityEngine.ExecuteAlwaysAttribute(),new UnityEngine.DisallowMultipleComponent()],"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"at":[new UnityEngine.ContextMenu.ctor("Apply Fit Now")],"a":2,"n":"ApplyFit","t":8,"sn":"ApplyFit","rt":$n[0].Void},{"a":1,"n":"Awake","t":8,"sn":"Awake","rt":$n[0].Void},{"a":1,"n":"CacheComponents","t":8,"sn":"CacheComponents","rt":$n[0].Void},{"a":1,"n":"FitSpriteRenderer","t":8,"sn":"FitSpriteRenderer","rt":$n[0].Void},{"a":1,"n":"FitUIImage","t":8,"sn":"FitUIImage","rt":$n[0].Void},{"a":1,"n":"OnDrawGizmosSelected","t":8,"sn":"OnDrawGizmosSelected","rt":$n[0].Void},{"a":2,"n":"SetSprite","t":8,"pi":[{"n":"newSprite","pt":$n[1].Sprite,"ps":0}],"sn":"SetSprite","rt":$n[0].Void,"p":[$n[1].Sprite]},{"a":2,"n":"SetSpriteRendererSize","is":true,"t":8,"pi":[{"n":"sr","pt":$n[1].SpriteRenderer,"ps":0},{"n":"sprite","pt":$n[1].Sprite,"ps":1},{"n":"targetSize","pt":$n[1].Vector2,"ps":2},{"n":"mode","dv":0,"o":true,"pt":SpriteSizeAdapter.FitMode,"ps":3}],"sn":"SetSpriteRendererSize","rt":$n[0].Void,"p":[$n[1].SpriteRenderer,$n[1].Sprite,$n[1].Vector2,SpriteSizeAdapter.FitMode]},{"a":1,"n":"Start","t":8,"sn":"Start","rt":$n[0].Void},{"a":1,"n":"_rectTransform","t":4,"rt":$n[1].RectTransform,"sn":"_rectTransform"},{"a":1,"n":"_spriteRenderer","t":4,"rt":$n[1].SpriteRenderer,"sn":"_spriteRenderer"},{"a":1,"n":"_uiImage","t":4,"rt":$n[6].Image,"sn":"_uiImage"},{"at":[new UnityEngine.HeaderAttribute("T\u1ef1 \u0111\u1ed9ng"),new UnityEngine.TooltipAttribute("T\u1ef1 \u0111\u1ed9ng c\u0103n ch\u1ec9nh khi ch\u1ea1y game ho\u1eb7c khi c\u00f3 thay \u0111\u1ed5i trong Inspector")],"a":2,"n":"autoFitOnStart","t":4,"rt":$n[0].Boolean,"sn":"autoFitOnStart","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"at":[new UnityEngine.TooltipAttribute("Ch\u1ebf \u0111\u1ed9 c\u0103n ch\u1ec9nh h\u00ecnh \u1ea3nh")],"a":2,"n":"fitMode","t":4,"rt":SpriteSizeAdapter.FitMode,"sn":"fitMode","box":function ($v) { return Bridge.box($v, SpriteSizeAdapter.FitMode, System.Enum.toStringFn(SpriteSizeAdapter.FitMode));}},{"a":2,"n":"gizmoColor","t":4,"rt":$n[1].Color,"sn":"gizmoColor"},{"at":[new UnityEngine.HeaderAttribute("Gizmos (H\u1ed7 tr\u1ee3 c\u0103n ch\u1ec9nh trong Scene)")],"a":2,"n":"showGizmos","t":4,"rt":$n[0].Boolean,"sn":"showGizmos","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"at":[new UnityEngine.HeaderAttribute("C\u1ea5u h\u00ecnh k\u00edch th\u01b0\u1edbc m\u1ee5c ti\u00eau"),new UnityEngine.TooltipAttribute("K\u00edch th\u01b0\u1edbc chu\u1ea9n mong mu\u1ed1n (Width, Height).\n- V\u1edbi SpriteRenderer: t\u00ednh theo \u0111\u01a1n v\u1ecb Unity Unit (vd: 2 x 3).\n- V\u1edbi UI Image: t\u00ednh theo \u0111\u01a1n v\u1ecb Pixel (vd: 200 x 300).")],"a":2,"n":"targetSize","t":4,"rt":$n[1].Vector2,"sn":"targetSize"}]}; }, $n);
    /*SpriteSizeAdapter end.*/

    /*SpriteSizeAdapter+FitMode start.*/
    $m("SpriteSizeAdapter.FitMode", function () { return {"td":SpriteSizeAdapter,"att":258,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"at":[new UnityEngine.TooltipAttribute("Gi\u1eef nguy\u00ean t\u1ec9 l\u1ec7 \u1ea3nh, thu ph\u00f3ng ph\u1ee7 k\u00edn to\u00e0n b\u1ed9 khung (Ph\u00f9 h\u1ee3p khi c\u00f3 Mask c\u1eaft ph\u1ea7n th\u1eeba)")],"a":2,"n":"Envelope","is":true,"t":4,"rt":SpriteSizeAdapter.FitMode,"sn":"Envelope","box":function ($v) { return Bridge.box($v, SpriteSizeAdapter.FitMode, System.Enum.toStringFn(SpriteSizeAdapter.FitMode));}},{"at":[new UnityEngine.TooltipAttribute("K\u00e9o gi\u00e3n \u1ea3nh v\u1eeba \u0111\u00fang k\u00edch th\u01b0\u1edbc khung (C\u00f3 th\u1ec3 b\u1ecb m\u00e9o t\u1ec9 l\u1ec7)")],"a":2,"n":"ExactStretch","is":true,"t":4,"rt":SpriteSizeAdapter.FitMode,"sn":"ExactStretch","box":function ($v) { return Bridge.box($v, SpriteSizeAdapter.FitMode, System.Enum.toStringFn(SpriteSizeAdapter.FitMode));}},{"at":[new UnityEngine.TooltipAttribute("Gi\u1eef nguy\u00ean t\u1ec9 l\u1ec7 \u1ea3nh, thu ph\u00f3ng sao cho to\u00e0n b\u1ed9 \u1ea3nh n\u1eb1m g\u1ecdn b\u00ean trong khung (Kh\u00f4ng b\u1ecb m\u00e9o)")],"a":2,"n":"FitInside","is":true,"t":4,"rt":SpriteSizeAdapter.FitMode,"sn":"FitInside","box":function ($v) { return Bridge.box($v, SpriteSizeAdapter.FitMode, System.Enum.toStringFn(SpriteSizeAdapter.FitMode));}}]}; }, $n);
    /*SpriteSizeAdapter+FitMode end.*/
