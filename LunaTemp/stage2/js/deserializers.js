...
Deserializers["AutoCameraFit"] = function (request, data, root) {
  ...
  var i707 = data
  i706.fitMode = i707[0]
  i706.referenceResolution = new pc.Vec2( i707[1], i707[2] )
  i706.referenceOrthographicSize = i707[3]
  i706.widthMode = i707[4]
  request.r(i707[5], i707[6], 0, i706, 'tallScreenObject')
  i706.tallScreenRatioThreshold = i707[7]
  i706.tallScreenYOffset = i707[8]
  request.r(i707[9], i707[10], 0, i706, 'canvasBtn')
  request.r(i707[11], i707[12], 0, i706, 'targetArea')
  i706.paddingLandscape = i707[13]
  i706.paddingPortrait = i707[14]
  i706.extraPaddingSmallScreen = i707[15]
  i706.smallScreenThreshold = i707[16]
  i706.autoUpdateOnResize = !!i707[17]
  i706.adjustInEditMode = !!i707[18]
  return i706
}
...
Deserializers["HaalandGame.HaalandGameManager"] = function (request, data, root) {
  ...
  request.r(i785[22], i785[23], 0, i784, 'haalandWin')
  i784.winPlayerDelay = i785[24]
  request.r(i785[25], i785[26], 0, i784, 'standPlayers')
  request.r(i785[27], i785[28], 0, i784, 'standPlayersAnimator')
  i784.standPlayerEnterTrigger = i785[29]
  request.r(i785[30], i785[31], 0, i784, 'questionUI')
  request.r(i785[32], i785[33], 0, i784, 'wrongChoiceUI')
  request.r(i785[34], i785[35], 0, i784, 'winChoiceUI')
  request.r(i785[36], i785[37], 0, i784, 'winExtraObj1')
  request.r(i785[38], i785[39], 0, i784, 'winExtraObj2')
  request.r(i785[40], i785[41], 0, i784, 'iconListUI')
  request.r(i785[42], i785[43], 0, i784, 'refereeAnimator')
  i784.refereeLookAroundTrigger = i785[44]
  i784.useAutoTimers = !!i785[45]
  i784.tackleHideDelay = i785[46]
  i784.impactCloudDelay = i785[47]
  i784.haalandHurtDelay = i785[48]
  i784.cloudDuration = i785[49]
  i784.refereeAnimDelay = i785[50]
  i784.nextActionDelay = i785[51]
  i784.dribbleToTackleDelay = i785[52]
  i784.tackleSoundDelay = i785[53]
  request.r(i785[54], i785[55], 0, i784, 'ronaldoChatBubble')
  request.r(i785[56], i785[57], 0, i784, 'messiChatBubble')
  request.r(i785[58], i785[59], 0, i784, 'viniChatBubble')
  request.r(i785[60], i785[61], 0, i784, 'mbappeChatBubble')
  request.r(i785[62], i785[63], 0, i784, 'ronaldoSpriteRenderer')
  request.r(i785[64], i785[65], 0, i784, 'ronaldoSadSprite')
  request.r(i785[66], i785[67], 0, i784, 'ronaldoEvilLaughSprite')
  request.r(i785[68], i785[69], 0, i784, 'messiSpriteRenderer')
  request.r(i785[70], i785[71], 0, i784, 'messiSadSprite')
  request.r(i785[72], i785[73], 0, i784, 'viniSpriteRenderer')
  request.r(i785[74], i785[75], 0, i784, 'viniSadSprite')
  request.r(i785[76], i785[77], 0, i784, 'mbappeSpriteRenderer')
  request.r(i785[78], i785[79], 0, i784, 'mbappeSadSprite')
  request.r(i785[80], i785[81], 0, i784, 'refereeSpriteRenderer')
  request.r(i785[82], i785[83], 0, i784, 'refereeReactionSprite')
  request.r(i785[84], i785[85], 0, i784, 'iconListAnimator')
  i784.currentLevel = i785[86]
  return i784
}
...
Deserializers["Luna.Unity.DTO.UnityEngine.Components.BoxCollider"] = function (request, data, root) {
  var i836 = root || request.c( 'Luna.Unity.DTO.UnityEngine.Components.BoxCollider' )
  var i837 = data
  i836.center = new pc.Vec3( i837[0], i837[1], i837[2] )
  i836.size = new pc.Vec3( i837[3], i837[4], i837[5] )
  i836.enabled = !!i837[6]
  i836.isTrigger = !!i837[7]
  request.r(i837[8], i837[9], 0, i836, 'material')
  return i836
}

Deserializers["HaalandGame.PlayerSelectable"] = function (request, data, root) {
  var i838 = root || request.c( 'HaalandGame.PlayerSelectable' )
  var i839 = data
  i838.playerType = i839[0]
  i838.targetLayerName = i839[1]
  return i838
}
...
Deserializers.buildID = "d95ca38f-5957-484e-ac1f-e6b6e3b82d58";
